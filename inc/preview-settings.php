...
class Ag_Theme_Builder_Settings extends Elementor\Core\Base\Document {
	...
	public static function get_title() {
		return __( 'Theme Builder', 'ag-theme-builder' );
	}

	public static function get_properties() {
		$properties = parent::get_properties();

		$properties['cpt']           = array( 'ag-themer' );
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_ag_preview_settings',
			array(
				'label' => __( 'Preview Settings', 'ag-theme-builder' ),
				'tab'   => Controls_Manager::TAB_SETTINGS,
			)
		);

		$default_archives = array(
			'archive/posts'            => __( 'Posts Archive', 'ag-theme-builder' ),
			'product_archive/products' => __( 'Products Archive', 'ag-theme-builder' ),
			'archive/author'           => __( 'Author Archive', 'ag-theme-builder' ),
			'archive/date'             => __( 'Date Archive', 'ag-theme-builder' ),
			'archive/search'           => __( 'Search Results', 'ag-theme-builder' ),
		);
		...
		$this->add_control(
			'preview_source',
			array(
				'label'   => __( 'Preview Source', 'ag-theme-builder' ),
				'type'    => Controls_Manager::SELECT,
				'default' => $query,
				'groups'  => array(
					''         => __( 'Select', 'ag-theme-builder' ),
					'single'   => array(
						'label'   => __( 'Singular', 'ag-theme-builder' ),
						'options' => $post_types,
					),
					'archive'  => array(
						'label'   => __( 'Archives', 'ag-theme-builder' ),
						'options' => $default_archives,
					),
					'taxonomy' => array(
						'label'   => __( 'Taxonomies', 'ag-theme-builder' ),
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Select Author', 'ag-theme-builder' ),
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Search Keyword', 'ag-theme-builder' ),
		...
		$this->add_control(
			...
			array(
				...
				'raw'       => '<div class="elementor-update-preview editor-ag-preview-update"><span>Update Preview</span><button class="elementor-button elementor-button-success"><i class="eicon eicon-spinner"></i>Apply</button>',
				'separator' => 'before',
			)
		);
	...
	public function switch_to_preview_query() {
		if ( 'ag-themer' === get_post_type( get_the_ID() ) ) {
